...
class Urna:
    ...
    Responsabilidades:
    - Gerenciar candidatos e eleitores
    - Controlar o fluxo de votação
    - Garantir segurança (voto único), sigilo (voto anônimo) e robustez
    - Encerrar e gerar o relatório de apuração
    """
